...
class StrengthBarDashedBarPainter extends CustomPainter {
  ...
  void paintBar(Canvas canvas, Size size) {
    ...
    if (dashCount == 1) {
      if (percentage > (100 * 1 / 4)) {
        percentage = 100;
      } else {
        percentage = (percentage / (100 * 1 / 4)) * 100;
      }
    }
    else if (dashCount == 2) {
      if (percentage > (100 * 2 / 4)) {
        percentage = 100;
      } else if (percentage < (100 * 1 / 4)) {
        percentage = 0;
      } else {
        percentage = ((percentage - (100 * 1 / 4)) / (100 * 1 / 4)) * 100;
      }
    }
    else if (dashCount == 3) {
      if (percentage > (100 * 3 / 4)) {
        percentage = 100;
      } else if (percentage < (100 * 2 / 4)) {
        percentage = 0;
      } else {
        percentage = ((percentage - (100 * 2 / 4)) / (100 * 1 / 4)) * 100;
      }
    }
    else if (dashCount == 4) {
      if (percentage > (100 * 4 / 4)) {
        percentage = 100;
      } else if (percentage < (100 * 3 / 4)) {
        percentage = 0;
      } else {
        percentage = ((percentage - (100 * 3 / 4)) / (100 * 1 / 4)) * 100;
      }
    }
